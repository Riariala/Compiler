...
class StatesTable(object):
    ...
    def __init__(self):
        ...
        self.States = {'S': {"":"F", '_':"ID",'\n': "S", '\t': "S", ' ': "S", '"':"STR2","'":"STR1", ';': "D", '@': "D", '^': "D", '+': "D" ,'*': "D" ,'-': "D" ,"/": "SL", "(": "BR" ,")": "D" ,"[": "D" ,"]": "D", ",": "D" ,".": "P", ":": "D", "<": "D" ,">": "D" ,"=": "D", "{": "COM1" ,"}": "ERR", "$": "16", "&": "8", "%":"2", "?":"D","^":"D","@":"D" },
                       'ID': {"":"F", '_':"ID",'\n': "F", '\t': "F", ' ': "F", '"':"F","'":"F", ';': "F", '@': "F", '^': "F", '+': "F" ,'*': "F" ,'-': "F" ,"/": "F", "(": "F", ")": "F" ,"[": "F" ,"]": "F", ",": "F" ,".": "F", ":": "F", "<": "F" ,">": "F" ,"=": "F"},
                       'N': {"{": "F", "":"F",'_':"ERR",'\n': "F", '\t': "F", ' ': "F", '"':"F","'":"F", ';': "F", '@': "F", '^': "F", '+': "F" ,'*': "F" ,'-': "F" ,"/": "F", "(": "F" ,")": "F" ,"[": "F" ,"]": "F", ",": "F" ,".": "NFPORD", ":": "F", "<": "F" ,">": "F" ,"=": "F"},
                       #'EXPORD': {"": "F", '_':"F",'\n': "F", '\t': "F", ' ': "F", '"':"F","'":"F", ';': "F", '@': "F", '^': "F", '+': "F" ,'*': "EXPFIN" ,'-': "F" ,"/": "F", "(": "F" ,")": "F" ,"[": "F" ,"]": "F", ",": "F" ,".": "F", ":": "F", "<": "F" ,">": "F" ,"=": "D"},
                       'D': {"": "F", '_':"F",'\n': "F", '\t': "F", ' ': "F", '"':"F","'":"F", ';': "F", '@': "F", '^': "F", '+': "F" ,'*': "F" ,'-': "F" ,"/": "F", "(": "F" ,")": "F" ,"[": "F" ,"]": "F", ",": "F" ,".": "D", ":": "D", "<": "D" ,">": "D" ,"=": "D"},
    ...
    def FillStates(self):
        for i in chain(range(65,91), range(97,123)):
            ...
            #self.States["EXPORD"][chr(i)] = "F"
            #self.States["EXPFIN"][chr(i)] = "F"
        for i in range(0,10):
            ...
            #self.States["EXPORD"][str(i)] = "F"
            #self.States["EXPFIN"][str(i)] = "F"
        self.States["8"]["8"] = "ERR"
        self.States["8"]["9"] = "ERR"
