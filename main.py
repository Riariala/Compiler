...
# сделать возможность не переписывать заново количество тестов (обработка исключений или просто поискать в док-ии посчитать в папке файлы)
